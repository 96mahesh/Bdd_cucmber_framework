package com.testperform.web.bdd.constants;
...
//	public static final String ICON_SOCIAL_GITHUB_VALUE = "https://github.com/rajatt95";
	...
	public static final String EXTENT_REPORT_FOLDER_PATH = PROJECT_PATH + "/Execution_reports/Web_Reports";
	public static final String EXTENT_REPORT_NAME = "Mobiotics.html";
	...
	public static String getExtentReportFilePath() {
		...
		if (extentReportFilePath.isEmpty()) {
			extentReportFilePath = com.testperform.web.bdd.Integrations.Common_Utils.ReportPathUtils
					.createExtentReportPath();
		}
